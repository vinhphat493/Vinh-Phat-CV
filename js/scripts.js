...
$btnModal.click(function(ele) {
  var currentBtn = $(ele.currentTarget);
  var dataTitle = currentBtn.attr("data-title");
  srcVideo = VIDEO_SRC[dataTitle];
  var videoTag = `
  <video autoplay controls class="modal-video">
